...
<body>
    ...
    <div id="search">
        <form method="post" action="cgpacal.php">
    ...
    <div class="center-div">
        <div class="table-responsive">
            <table>
                ...
                $cgpa=$_POST['cgpa'];
                $selectquery = "SELECT * from register WHERE cgpa>=$cgpa";
  ...
  <?php
  $url_prameters='$cgpa=' . $cgpa ;
  echo'<div class = "export-container">';
          echo '<center>
                        <button class = "btn">
                            <a href="downcgpacal.php?'.$url_prameters . '">Download XL</a>
